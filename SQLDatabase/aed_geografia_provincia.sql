...
CREATE TABLE `provincia` (
  ...
  `capitalProvincia` varchar(45) DEFAULT NULL,
  `superficieProvincia` varchar(45) DEFAULT NULL,
  `poblacionProvincia` varchar(45) DEFAULT NULL,
...
INSERT INTO `provincia` VALUES (1,'Santa Cruz de Tenerife','3.381km2','1 millon','Santa Cruz de Tenerife');
